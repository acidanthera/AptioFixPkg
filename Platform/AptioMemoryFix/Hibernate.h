...
#ifndef APTIOFIX_HIBERNATE_H
#define APTIOFIX_HIBERNATE_H

#pragma pack(push, 1)

//
// High Sierra image header (xnu/iokit/IOKit/IOHibernatePrivate.h)
// It's good for Lion and and newer as well since
