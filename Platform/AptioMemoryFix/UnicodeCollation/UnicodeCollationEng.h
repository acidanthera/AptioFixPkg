...
/**
  The user Entry Point for UnicodeCollation compatibility support in English.

  This function initializes unicode character mapping and then installs Unicode
  Collation 2 Protocol if applicapble for the target system.
  In case EFI_PLATFORM_LANG_VARIABLE_NAME is missing it is additionally set to
  en-us as a default value.
