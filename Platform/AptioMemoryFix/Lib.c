...
EFI_GUID gAppleVendorGuid                            = {0xAC39C713, 0x7E50, 0x423D, {0x88, 0x9D, 0x27, 0x8F, 0xCC, 0x34, 0x22, 0xB6}};
EFI_GUID gAppleTrbSecureVariableGuid                 = {0xF68DA75E, 0x1B55, 0x4E70, {0xB4, 0x1B, 0xA7, 0xB7, 0xA5, 0xB7, 0x58, 0xEA}};
...
MAP_EFI_GUID_STR EfiGuidStrMap[] = {
	...
	{&gAppleVendorGuid, L"gAppleVendorGuid"},
